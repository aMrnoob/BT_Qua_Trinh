...
public class GridViewSubject extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridView gvSubject = findViewById(R.id.gvSubjects);
        ...
        gvSubject.setOnItemLongClickListener((parent, view, position, id) -> {
        ...
        btnListView.setOnClickListener(v -> {
            Intent intent = new Intent(GridViewSubject.this, ListViewSubject.class);
            startActivity(intent);
        });

        btnRecyclerView.setOnClickListener(v -> {
            Intent intent = new Intent(GridViewSubject.this, RecyclerViewSubject.class);
            startActivity(intent);
        });
    }
}